...
zip -r my_functions/get_reviews/get_reviews.zip games_reviews.go go.mod go.sum controller/reviews_controller.go api/limit.go api/routes_get_reviews.go steamapi/persistence/client_db.go steamapi/persistence/storage.go steamapi/service/review_fetcher.go steamapi/model/review.go steamapi/persistence/entity/table_model.go cache/redis_cache.go config
...
gsutil cp my_functions/get_reviews/get_reviews.zip gs://steam-analytics
